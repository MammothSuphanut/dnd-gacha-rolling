...
เมื่อโจมตี เพิ่มระยะการโจมตีครั้งถัดไป — ถ้าการโจมตีครั้งนี้ติด สามารถเคลื่อนที่ได้ทันที **10 ft ต่อ stack** ที่จ่าย (จ่าย 1 Aura ต่อ stack เพิ่ม) โดยไม่โดน Opportunity Attack (ใช้ได้ทั้งระยะประชิดและระยะไกล) — ไม่มีเพดาน stack สูงสุด จำกัดแค่ Aura ที่มีอยู่
...
เมื่อโจมตี เพิ่มดาเมจ Radiant **+1d4 ต่อ stack** ที่จ่าย (จ่าย 1 Aura ต่อ stack เพิ่ม) — ไม่มีเพดาน stack สูงสุด จำกัดแค่ Aura ที่มีอยู่
...
#### Sun Slash — 2 Aura ต่อ stack
โจมตีแบบพลังพวยพุ่งรอบตัวเป็นพื้นที่สี่เหลี่ยมจัตุรัส **15×15 ft** — ทุกเป้าหมายในพื้นที่ทำ Dexterity Saving Throw (DC = 8 + Proficiency Bonus + Wisdom modifier) รับดาเมจ Radiant **1d6 ต่อ stack** ที่จ่าย (เซฟผ่านลดดาเมจครึ่งหนึ่ง) — ไม่มีเพดาน stack สูงสุด จำกัดแค่ Aura ที่มีอยู่ (เช่น จ่าย 36 Aura ได้ 18d6)
