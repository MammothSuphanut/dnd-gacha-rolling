...
|---|---|---|---|---|---|---|---|---|
| Ambition Domain | PSA 🕰️ | 6 (B) | 6 (B) | 8 (A) | 8 (A) | 6 (B) | 6 (B) | 8 (A) |
| Arcana Domain | SCAG 🕰️ | 7 (A) | 7 (A) | 8 (A) | 7 (A) | 7 (A) | 8 (A) | 8 (A) |
| Death Domain | DMG 🕰️ | 8 (A) | 5 (B) | 8 (A) | 7 (A) | 6 (B) | 6 (B) | 7 (A) |
| Destruction Domain | VSS 🕰️ | 8 (A) | 5 (B) | 8 (A) | 7 (A) | 7 (A) | 6 (B) | 7 (A) |
| Eldritch Domain | GrimHollowPG24 | 7 (A) | 8 (A) | 8 (A) | 8 (A) | 7 (A) | 6 (B) | 8 (A) |
| Forge Domain | XGE 🕰️ | 7 (A) | 5 (B) | 8 (A) | 9 (S) | 6 (B) | 7 (A) | 7 (A) |
| Grave Domain | RHW | 8 (A) | 7 (A) | 10 (S) | 8 (A) | 7 (A) | 6 (B) | 8 (A) |
| Inquisition Domain | GrimHollowPG24 | 8 (A) | 5 (B) | 9 (S) | 8 (A) | 7 (A) | 6 (B) | 8 (A) |
| Knowledge Domain | FRHoF | 6 (B) | 6 (B) | 8 (A) | 7 (A) | 6 (B) | 9 (S) | 9 (S) |
| Life Domain | XPHB | 6 (B) | 5 (B) | 10 (S) | 8 (A) | 7 (A) | 6 (B) | 7 (A) |
| Light Domain | XPHB | 7 (A) | 5 (B) | 9 (S) | 8 (A) | 6 (B) | 6 (B) | 8 (A) |
| Madness Domain | VSS 🕰️ | 6 (B) | 8 (A) | 8 (A) | 8 (A) | 6 (B) | 6 (B) | 8 (A) |
| Nature Domain | PHB 🕰️ | 6 (B) | 6 (B) | 8 (A) | 8 (A) | 6 (B) | 6 (B) | 7 (A) |
| Order Domain | TCE 🕰️ | 6 (B) | 7 (A) | 9 (S) | 7 (A) | 8 (A) | 6 (B) | 8 (A) |
| Peace Domain | TCE 🕰️ | 6 (B) | 5 (B) | 10 (S) | 8 (A) | 7 (A) | 6 (B) | 7 (A) |
| Pestilence Domain | ValdaSpire24Extras | 7 (A) | 8 (A) | 8 (A) | 7 (A) | 7 (A) | 7 (A) | 8 (A) |
| Purification Domain | GrimHollowPG24 | 8 (A) | 6 (B) | 8 (A) | 8 (A) | 7 (A) | 8 (A) | 8 (A) |
| Rum Domain | VSS 🕰️ | 6 (B) | 6 (B) | 8 (A) | 8 (A) | 7 (A) | 6 (B) | 8 (A) |
| Solidarity Domain | PSA 🕰️ | 6 (B) | 5 (B) | 10 (S) | 7 (A) | 7 (A) | 6 (B) | 7 (A) |
| Strength Domain | PSA 🕰️ | 6 (B) | 5 (B) | 8 (A) | 8 (A) | 6 (B) | 6 (B) | 7 (A) |
| Tempest Domain | PHB 🕰️ | 8 (A) | 6 (B) | 8 (A) | 7 (A) | 6 (B) | 7 (A) | 8 (A) |
| Travel Domain | VSS 🕰️ | 7 (A) | 5 (B) | 8 (A) | 8 (A) | 7 (A) | 8 (A) | 8 (A) |
| Trickery Domain | XPHB | 6 (B) | 5 (B) | 9 (S) | 8 (A) | 7 (A) | 7 (A) | 8 (A) |
| Twilight Domain | TCE 🕰️ | 6 (B) | 5 (B) | 9 (S) | 8 (A) | 7 (A) | 7 (A) | 8 (A) |
| War Domain | XPHB | 8 (A) | 5 (B) | 9 (S) | 8 (A) | 8 (A) | 6 (B) | 8 (A) |
| Wealth Domain | VSS 🕰️ | 6 (B) | 6 (B) | 8 (A) | 7 (A) | 6 (B) | 8 (A) | 8 (A) |
| Zeal Domain | PSA 🕰️ | 9 (S) | 6 (B) | 8 (A) | 7 (A) | 8 (A) | 6 (B) | 8 (A) |
...
| **Survivability** | 8/10 (A) | Warding Flare ใช้ป้องกันตัวเองได้ด้วย (reaction, Wis mod ครั้ง/วัน กด Disadvantage การโจมตีใส่ตัวเอง) [M:2/4] [R:2/3] [B:3/3] |
...
| **Versatility** | 8/10 (A) | ภาพลวงตา (Invoke Duplicity → Improved Duplicity 4 ตัวที่ lv17) + Cloak of Shadows (invisible) ให้เล่นบท scout/decoy ได้นอกเหนือจาก caster ปกติ [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 8/10 (A) | Arcane Initiate ให้ cantrip wizard 2 ตัว + Arcana proficiency บวก Arcane Mastery (lv17) เข้าถึง spell wizard ระดับ 6-9 (เช่น Teleportation Circle, True Seeing) — breadth utility กว้างขึ้นมาก [M:2/4] [R:2/3] [B:3/3] |
...
| **Versatility** | 8/10 (A) | กลไก roll-table เดียวให้ผลทั้งดาเมจและ control หลายรูปแบบสลับกันได้ [M:2/4] [R:2/3] [B:3/3] |
...
| **Versatility** | 8/10 (A) | ผสมดาเมจ/control/support/tank รอบธีม "สถานะ Bloodied และการตาย" ได้กว้าง [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 6/10 (B) | ไม่มี utility นอกคอมแบตใหม่ = เท่า baseline |
| **Versatility** | 8/10 (A) | ดาเมจ+ป้องกัน+ตอบโต้ทั้งหมดโฟกัสรอบธีม anti-magic เฉพาะทาง แต่ยังครอบคลุมหลายบทบาทพร้อมกัน [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 9/10 (S) | Unfettered Mind ให้ telepathy 60ft คุยพร้อมกันได้หลายตัว บวก Divine Foreknowledge (lv17, bonus action) ให้ Advantage บน d20 test **ทุกประเภท** นาน 1 ชม. — utility breadth กว้างที่สุดใน domain ที่ทำมา [M:3/4] [R:2/3] [B:3/3] |
| **Versatility** | 9/10 (S) | Divine Foreknowledge (Advantage บน d20 test ทุกแบบ 1 ชม.) เป็นบัฟที่ใช้ได้กับทุก build/ทุกสถานการณ์แบบไม่ผูก archetype เลย [M:3/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Blessed Healer คืน HP ให้ตัวเองทุกครั้งที่ฮีลคนอื่นด้วย spell slot [M:2/4] [R:2/3] [B:3/3] |
...
| **Support** | 9/10 (S) | Warding Flare ใช้ปกป้องเป้าหมายอื่นที่ถูกโจมตีได้ (ไม่จำกัดแค่ตัวเอง) และ Improved Warding Flare (lv6) มอบ temp HP ให้เป้าที่ถูกโจมตีทุกครั้งที่ใช้ + ฟื้นทุก short rest — ปกป้องทีมได้จริงและถี่ [M:2/4] [R:3/3] [B:3/3] |
...
| **Versatility** | 8/10 (A) | Warding Flare เลือกใช้ได้ทั้งดาเมจ(อ้อม)/ป้องกัน/support ในกลไกเดียว [M:2/4] [R:2/3] [B:3/3] |
...
| **Support** | 8/10 (A) | ไม่มี feature เสริมทีมใหม่ = เท่า baseline |
| **Survivability** | 8/10 (A) | Fragmented Mind ให้ Advantage ต้าน charmed/frightened/mind-read และแชร์ให้ ally ได้ผ่านพิธีกรรม 10 นาที [M:2/4] [R:3/3] [B:2/3] |
...
| **Versatility** | 8/10 (A) | Embrace Unreality เลือกโหมดปรับกฎสนามรบได้หลายแบบ (mobility/adv-disadv สลับ/ห้ามเคลื่อนที่/ปรับขนาด) [M:2/4] [R:2/3] [B:3/3] |
...
| **Support** | 8/10 (A) | ไม่มี feature เสริมทีมใหม่ = เท่า baseline |
| **Survivability** | 8/10 (A) | Dampen Elements (reaction) ให้ resistance ดาเมจ 5 ธาตุแก่ตัวเองหรือ ally ในระยะ 30ft [M:2/4] [R:2/3] [B:3/3] |
| **Action Economy** | 6/10 (B) | ไม่มี economy gain ใหม่ = เท่า baseline |
...
| **Versatility** | 8/10 (A) | ผสมดาเมจ/control/support รอบธีม "ผู้บัญชาการสนามรบ" ได้กว้าง [M:2/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Emboldening Bond ผูกตัวเองได้ด้วย + Protective Bond อาจมี bondmate สลับมารับดาเมจแทนตัวเองได้ [M:2/4] [R:2/3] [B:3/3] |
...
| Axis | คะแนน | เหตุผล |
|---|---|---|
| **Damage** | 7/10 (A) | Bloodmore (ตัวเลือกหนึ่งของ Infection) ให้ extra necrotic 1d6 ทุกครั้งที่เป้าโดน BPS damage ตลอด 1 นาที — magnitude เล็กแต่ต่อเนื่อง [M:2/4] [R:2/3] [B:2/3] |
...
| **Utility** | 7/10 (A) | Inoculate เป็นเครื่องมือแก้พิษ/โรคที่ใช้นอกคอมแบตได้จริง [M:2/4] [R:2/3] [B:2/3] |
| **Versatility** | 8/10 (A) | Infection เลือกเอฟเฟกต์ได้ 3 แบบตามสถานการณ์ (ควบคุม/ดาเมจ/ปิดสายตา) บวกระบบแพร่กระจายเป็นวงกว้างที่ lv17 [M:2/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Ward Against Corruption ให้ Advantage ต้านโรค/polymorph แก่ตัวเอง [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 8/10 (A) | Sear Imperfections (lv17) แคส Lesser/Greater Restoration ได้ฟรีไม่จำกัดโดยไม่เสีย slot (แลกด้วยดาเมจไฟ) — utility รักษาอาการ/คำสาปที่ทรงพลัง [M:2/4] [R:2/3] [B:3/3] |
| **Versatility** | 8/10 (A) | ผสมดาเมจ/debuff/utility รักษารอบธีมไฟ-การชำระล้าง [M:2/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Drunken Sway ให้ AC = 10+Dex+Wis เมื่อไม่ใส่เกราะ/ถือโล่ — ทางเลือก AC ที่สูสีหรือดีกว่าเกราะบางแบบได้จริง [M:2/4] [R:2/3] [B:3/3] |
| **Action Economy** | 7/10 (A) | Rumrunner (reaction) เคลื่อนที่ครึ่งความเร็วฟรีไม่โดน OA เมื่อศัตรูขยับ — เครื่องมือจัดตำแหน่งที่ไม่เสีย action หลัก [M:2/4] [R:2/3] [B:2/3] |
| **Utility** | 6/10 (B) | ส่วนใหญ่เป็น flavor (ทนเหล้า) = เท่า baseline |
| **Versatility** | 8/10 (A) | ผสม tank(Drunken Sway)/skirmisher(Rumrunner)/control(Intoxicate) ได้หลายบทบาท [M:2/4] [R:2/3] [B:3/3] |
...
| **Action Economy** | 7/10 (A) | Solidarity's Action ให้ตีอาวุธเป็น bonus action ได้ทุกครั้งที่ใช้ Help action (Wis mod ครั้ง/วัน) [M:2/4] [R:2/3] [B:2/3] |
| **Utility** | 6/10 (B) | ไม่มี utility นอกคอมแบตใหม่ = เท่า baseline |
...
| **Control** | 6/10 (B) | Thunderbolt Strike ผลักเป้า Large หรือเล็กกว่าไป 10ft เมื่อโดน lightning dmg — forced-movement เล็กน้อยที่ baseline ไม่มี [M:1/4] [R:2/3] [B:2/3] |
| **Support** | 8/10 (A) | ไม่มี feature เสริมทีมใหม่ = เท่า baseline |
...
| **Utility** | 7/10 (A) | Stormborn (lv17) ให้บินได้เท่าความเร็วเดินตลอดเวลานอกที่ร่ม/ใต้ดิน — mobility utility ถาวร [M:2/4] [R:2/3] [B:2/3] |
| **Versatility** | 8/10 (A) | ผสมดาเมจ/forced-movement/mobility รอบธีมพายุ [M:2/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Jaunt (bonus action, Wis mod ครั้ง/วัน) เคลื่อนที่ 10ft ไม่โดน OA เป็นเครื่องมือหนีตัวเองที่ baseline ไม่มี [M:2/4] [R:2/3] [B:3/3] |
...
| **Versatility** | 8/10 (A) | เปิด role skirmisher/mobility เพิ่มจาก caster ปกติ ผ่าน Jaunt+Godspeed [M:2/4] [R:2/3] [B:3/3] |
...
| **Survivability** | 8/10 (A) | Trickster's Transposition (teleport สลับที่กับภาพลวงตาได้ไกลถึง 120ft) เป็นเครื่องมือหนีตัวเองที่ดี [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 7/10 (A) | ภาพลวงตาใช้แทรกซึม/สอดแนม/หลอกล่อได้จริงนอกคอมแบต [M:2/4] [R:2/3] [B:2/3] |
| **Versatility** | 8/10 (A) | ผสม stealth/illusion/repositioning/combat advantage ในกลไกเดียว — hybrid rogue-caster ชัดเจน [M:2/4] [R:2/3] [B:3/3] |
...
| **Action Economy** | 7/10 (A) | Steps of Night (bonus action, prof bonus ครั้ง/วัน) ให้บินได้ในที่มืด — mobility ที่ไม่เสีย action หลัก [M:2/4] [R:2/3] [B:2/3] |
| **Utility** | 7/10 (A) | Eyes of Night (darkvision 300ft แชร์ให้ทีมได้ 1 ชม.) เป็น exploration utility กว้างมาก [M:2/4] [R:2/3] [B:2/3] |
| **Versatility** | 8/10 (A) | ผสม support/utility/mobility ผ่าน Twilight Sanctuary ที่เลือกผลได้ทุกเทิร์น [M:2/4] [R:2/3] [B:3/3] |
...
| **Control** | 5/10 (B) | ไม่มี control feature ใหม่ = เท่า baseline |
| **Support** | 9/10 (S) | Guided Strike (CD) ให้ +10 บน attack roll ของตัวเองหรือ ally ในระยะ 30ft แบบ reaction — เปลี่ยน miss เป็น hit ได้แทบรับประกัน [M:3/4] [R:2/3] [B:3/3] |
...
| **Utility** | 6/10 (B) | ไม่มี utility นอกคอมแบตใหม่ = เท่า baseline |
| **Versatility** | 8/10 (A) | ผสมดาเมจ/support/tank แบบ martial-caster hybrid ที่โฟกัสคอมแบตล้วน [M:2/4] [R:2/3] [B:3/3] |
...
|---|---|---|
| **Damage** | 6/10 (B) | ไม่มี feature เพิ่มดาเมจใหม่ = เท่า baseline |
| **Control** | 6/10 (B) | Bribe (action, Cha save) ทำให้ศัตรูหยุดเป็นศัตรูนาน 24 ชม. — pacify tool ที่ baseline ไม่มี แต่ต้องเสียทองและใช้นอกคอมแบตเป็นหลัก [M:2/4] [R:1/3] [B:2/3] |
...
| **Versatility** | 8/10 (A) | เปิด role นักเจรจา/พ่อค้าที่ Cleric ปกติไม่มี ควบคู่กับ pacify tool [M:2/4] [R:2/3] [B:3/3] |
...
| **Utility** | 6/10 (B) | ไม่มี utility นอกคอมแบตใหม่ = เท่า baseline |
| **Versatility** | 8/10 (A) | ผสมดาเมจ/forced-movement/economy รอบธีมนักรบผู้คลั่งไคล้ [M:2/4] [R:2/3] [B:3/3] |
