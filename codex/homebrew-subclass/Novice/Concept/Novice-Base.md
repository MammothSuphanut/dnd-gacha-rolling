...
> 🚧 **สถานะ: DRAFT** — มี D&D Feature Draft แล้วสำหรับ Strike/First Aid/Play Dead ในรูปแบบ **Job Skill (Rank 1-4)** ตาม [ระบบการเลือก/อัพเกรด Job Skill](Novice-Concept.md#ระบบการเลือกอัพเกรด-job-skill-pick--upgrade-schedule) ของ Novice-Concept.md — ได้ทั้ง **3 Job Skill อัตโนมัติ ไม่ต้องเลือก** (Strike + First Aid ที่ level 1, Play Dead ที่ level 2) ทุก Job Skill อัป Rank เองพร้อมกันที่ lv9/13/17 จนเต็ม Rank 4 ตอน lv17 — **Tame Pet ตัดออกจากสโคปแล้ว ไม่ใช้งาน** และ Skill #1000104 ที่ไม่มีข้อมูลต้นทางก็ไม่ใช้เช่นกัน
...
| Job Skill | หมวด | Mana | Rank 1 (หยิบครั้งที่ 1) | Rank 2 | Rank 3 | Rank 4 |
|---|---|---|---|---|---|---|
...
- Tame Pet: 🔄 **2026-08-23** ตัดออกจากสโคปแล้ว (ไม่ทำเป็น pet mechanic) — ไม่ใช่ Job Skill ของ pool นี้อีกต่อไป
