...
- [x] วางแผนผสาน Dungeon of the Mad Mage Companion เข้ากับ WDMM หลัก (ดู [99-notes.md](./99-notes.md))
...
- [x] **EP3: Fireball** แปล/ขยายเป็น journal เต็มแล้ว (ระเบิดกลางเมือง → สืบสวนหา Urstul Floxin/Nim's nimblewright → บุก Gralhund Villa เต็มรูปแบบ G1-G19 → nimblewright หนีพร้อม Stone of Golorr → Loose Ends: Istrid Horn)

## กำลังทำ / รอคิว (Act 1: Dragon Heist)

**2026-08-12 ตัดสินใจใหม่**: Ch.4 กับ Ch.5-8 ไม่ fix วายร้ายไว้ล่วงหน้าแล้ว — เขียน journal เต็มทั้ง 4 สายแยกไฟล์กัน (กฎ 2.6 ใน [structure-guide.md](../../adventure-builder/structure-guide.md)) เลือกรันแค่ไฟล์เดียวตอนเล่นจริง ดูรายละเอียดที่ [CH04-dragon-season.md](ACT01-dragon-heist/CH04-dragon-season.md) และ [00-act-outline.md](ACT01-dragon-heist/00-act-outline.md)

- [x] **EP4: Spring Encounter Chain (Xanathar)** แปล/ขยายเป็น journal เต็มแล้ว (Mistshore → Mausoleum → Converted Windmill → Cellar Complex → Street Chase → Old Tower → Alley → Theater, พร้อม Vault Keys เต็มตาราง — จบที่ทางลงสู่ Vault of Dragons)
- [x] **EP5: Summer Encounter Chain (Cassalanters)** แปล/ขยายเป็น journal เต็มแล้ว (Mausoleum → Converted Windmill → Rooftop Chase → Alley → Street Chase → Cellar Complex → Courthouse → Old Tower — จบที่ทางลงสู่ Vault of Dragons)
- [x] **EP6: Autumn Encounter Chain (Jarlaxle)** แปล/ขยายเป็น journal เต็มแล้ว (Alley → Cellar Complex → Theater → Courthouse → Old Tower → Rooftop Chase → Mistshore → Converted Windmill — จบที่ทางลงสู่ Vault of Dragons)
- [x] **EP7: Winter Encounter Chain (Manshoon)** แปล/ขยายเป็น journal เต็มแล้ว (Converted Windmill → Alley → Rooftop Chase → Theater → Street Chase → Mistshore → Old Tower → Mausoleum — จบที่ทางลงสู่ Vault of Dragons)
...
## ที่เหลือ (ถ้าจะเล่นจริง)
- [ ] เตรียมแมพ custom เพิ่มเติมนอกเหนือจากรูปต้นฉบับที่แนบไว้แล้ว
- [ ] ทวนสอบ stat block/DC ที่ปรับแต่งเองเทียบกับหนังสือกฎจริงก่อนรันโต๊ะ
