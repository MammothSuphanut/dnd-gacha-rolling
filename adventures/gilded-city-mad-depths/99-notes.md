...
ใช้ motif นี้ต่อเนื่องตลอดทั้ง Act 2 (Undermountain) ทุกชั้น ไม่ใช่แค่บางชั้น — Halaster มองปาร์ตี้เป็นผู้เข้าแข่งขันในเกมโชว์ข้ามมิติของตัวเอง แทรก trivia/บทพูดผ่านจิตตามจุดที่ Companion ระบุไว้ในแต่ละชั้น และปิดท้ายทุกชั้นด้วย "The Host's Send-Off" แทน epilogue ธรรมดา — เข้ากับธีม "กฎเกณฑ์แห่งการทำลายล้างเฝ้ามองความวิบัติเหมือนมหรสพ" ที่ผูกไว้กับ Astral Nexus lore พอดี (ดู [00-overview.md](./00-overview.md)) — **เอกสารกรอบเต็ม (7 เป้าหมายของ Halaster, Gags & Gimmicks, 10 แฟกชัน, ตาราง 31 ประตูลัด) อยู่ที่ [03-halasters-game-framework.md](./03-halasters-game-framework.md) แล้ว (2026-08-12)**
