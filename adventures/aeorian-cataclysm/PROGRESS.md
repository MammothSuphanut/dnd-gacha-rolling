...
- [ ] ลง detail ระดับ session-by-session/encounter (stat block เต็ม, DC เฉพาะจุด, boxed read-aloud text) — ตอนนี้มีแค่ระดับ outline + CR แนะนำ ยังไม่ใช่ journal เต็มรูปแบบ (ใช้ `/build-journal` ได้เมื่อพร้อม)
